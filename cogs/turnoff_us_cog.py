...
class TurnOffUsCog(commands.Cog):
    ...
    def __init__(self, bot, config, logger):
        ...
        self.config = config
        self.logger = logger
        self.turnoff_us_scraper = TurnOffUsScraper(config=config, logger=logger)
